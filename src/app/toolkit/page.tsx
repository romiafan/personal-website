...
export default async function ToolkitPage() {
  ...
  <p className="text-muted-foreground max-w-2xl">Internal utilities (JSON formatting & CSV, JSON→TS, JWT decode, palette extraction, UUIDs, timestamps, encoding, regex, text diff, markdown preview, case conversion, audit logs, color, lorem ipsum). More coming soon.</p>
      <div className="grid gap-8 lg:grid-cols-2">
        <div className="space-y-6">
          <div className="rounded-lg border bg-background p-4"><JsonTools /></div>
          <div className="rounded-lg border bg-background p-4"><JsonToTsInterfaceTool /></div>
        </div>
        <div className="space-y-6">
          <div className="rounded-lg border bg-background p-4"><UuidGeneratorTool /></div>
          <div className="rounded-lg border bg-background p-4"><TimestampConverter /></div>
          <div className="rounded-lg border bg-background p-4"><CodecTool /></div>
          <div className="rounded-lg border bg-background p-4"><RegexTester /></div>
          <div className="rounded-lg border bg-background p-4"><JwtDecoder /></div>
          <div className="rounded-lg border bg-background p-4"><ColorPaletteExtractor /></div>
          <div className="rounded-lg border bg-background p-4"><TextDiffTool /></div>
          <div className="rounded-lg border bg-background p-4"><MarkdownPreviewTool /></div>
          <div className="rounded-lg border bg-background p-4"><CaseConverterTool /></div>
          <div className="rounded-lg border bg-background p-4"><AuditLogViewer /></div>
